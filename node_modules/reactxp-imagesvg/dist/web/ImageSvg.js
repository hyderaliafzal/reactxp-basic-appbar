...
var ImageSvg = /** @class */ (function (_super) {
    ...
    ImageSvg.prototype.render = function () {
        ...
        if (this.props.width > 0 && this.props.height > 0) {
            ...
            return (React.createElement("svg", { viewBox: this.props.viewBox, style: combinedStyles, height: this.props.height, width: this.props.width, alt: this.props.accessibilityLabel, title: this.props.title }, this.props.children));
        }
        else {
            return null;
        }
